...
model = AR2Model_single(n, phi1=1.45,phi2=-0.5,noise=10.0) # noise = float
...
plot(t, S[5,:],'b-D',linewidth=3.5,label="true value")
plot(t, -Shat[5,:],'c-o',linewidth=3.5,label="AR model")
plot(t, -pseudo_meas['Pk'][NonMeasIdx.index(5),:],'m-',linewidth=5.5,label="pseudo-measurements",alpha=0.5)   
